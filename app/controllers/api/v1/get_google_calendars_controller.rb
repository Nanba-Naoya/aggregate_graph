module Api::V1
  class GetGoogleCalendarsController < ApplicationController
    ...
    def index
      puts params
      a = `curl -d client_id=1062349073075-3l06qo9t1huckd0d58mr1g6n3h9tpgbm.apps.googleusercontent.com -d client_secret=T1g-7nU2bbYg5WUOgDh_Fm5e -d redirect_uri=http://localhost:4200 -d grant_type=authorization_code -d code=#{params} https://accounts.google.com/o/oauth2/token`
      ...
      #time_min = Time.utc(2018, 12, 6, 00, 00, 00).iso8601
      #time_max = Time.utc(2018, 12, 13, 23, 59, 59).iso8601
